...
getQuote(); //get a quote when first initializing the page
...
var twitterURL = "https://twitter.com/intent/tweet" + "?text=" + encodeURIComponent(currentFormatedQuote) + "&hashtags=quote";
window.open(twitterURL, "Share");
});

//handle tumblr button clicks
$("#btn-tumblr").on("click", function(){
var tumblrURL = "https://www.tumblr.com/widgets/share/tool?posttype=quote&tags='#quote'&quote=" + currentQuote + "&caption=" + currentAuthor;
